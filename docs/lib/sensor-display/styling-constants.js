...
export const CARDICON_CLASSLIST = ["fas", "fa-leaf"];

export const READINGS_CLASSLIST = ["level", "my-5", "is-mobile"];
export const READING_CLASSLIST = ["level-item", "has-text-centered"];
export const READINGLABEL_CLASSLIST = ["heading"];
